...
namespace RestApiDestinations.Controllers
{
    ...
    public class DestinationsController : ControllerBase
    {
        ...
        public DestinationsController(AppDbContext context, CountryCodeService countryCodeService)
        {
            _context = context;
        ...
        public async Task<ActionResult<Destination>> GetDestination(int id)
        {
            ...
            string countryCode = _countryCodeService.GetCountryCode(destination.Name);
